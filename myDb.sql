...
, s_user_id INT REFERENCES s_user 
);

CREATE TABLE recipe_keyword_group
...
-- recipe_keyword_group seeding

INSERT INTO recipe_keyword_group
( recipe_id
, keyword_id
)
VALUES
